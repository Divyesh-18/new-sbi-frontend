    ...
    <div class="admin-layout">
        ...
        <div class="main-content-wrapper main-content-table Period_History">
            ...
            <div class="period_history_table ">
                <header>
                    <h5 class="p-1 setresultgame-title">Fast Win Set Result</h5>
                </header>
...
export default {
    ...
    methods: {
        async gameID() {
            try {
                const response = await axios.get(`admin/fast-win-period-id`, {});
        ...
        async setResult() {
            try {
                ...
                if (this.gameid && this.gameid != "") {
                    response = await axios.post(`admin/fast-win-set-result-game`, {
                        actiontype: "getdata",
                        tab: "parity",
                    ...
                    this.socket.on("fastWinBate", (data1) => {
        ...
        async updateResultStatus(number) {
            try {
                // this.loader = true;
                const response = await axios.post(`admin/fast-win-select-result-number`, {
                    number: number,
                });
