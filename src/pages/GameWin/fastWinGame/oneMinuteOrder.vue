<template>
    ...
    <div class="appHeader1">
        <div class="left">
            ...
            <div class="pageTitle">Fast Win Orders</div>
        </div>
    </div>
                        ...
                        <table class="table table-borderless" id="myrecordparityt">
                            ...
                            <tbody>
                                ...
                                <tr v-on:click="
                                    ...
                                    " v-for="item in waitlist" :key="item.id"
                                    class="clickable user-order-table arrow-custom">
                                    <td class="myRecordTd" style="border: none">
                                        ...
                                        <div id="t" class="detail mt-1 mb-1 p-1"
                                            v-show="isResultCollapseOpen === item.id ? true : false"
                                            style="padding: 0px 30px">
                                            <p style="color: #2d9688; text-align: start; font-weight: bolder;">Period
                                                Detail</p>
                                            ...
                                            <div class="mt-1" style="display: flex">
                                                ...
                                                <div class="point2 addclass" style="color: #4caf50 !important"
                                                    v-if="item.value === 'Green'">
                                                    {{ item.value }}
                                                </div>
                                            ...
                                            <div class="mt-1" style="display: flex">
                                                ...
                                                <div class="point2 addclass"
                                                    style="color: #f39839 !important; font-size: 14px">
                                                    Wait
                                                </div>
                                            </div>
                                            <div class="mt-1" style="display: flex">
                                                ...
                                                <div class="point2 addclass"
                                                    style="color: #4caf50 !important; font-size: 14px"
      ...
      <div class="point2 addclass">{{ item.type }}</div>
                                ...
                                <tr v-on:click="
                                    ...
                                    <td class="myRecordTd" style="border: none">
                                        ...
                                        <div id="t" class="myRecordDetail detail mt-1"
                                            v-show="isResultCollapseOpen === item.id ? true : false">
                                            <p
                                                style="color: #2d9688; font-size: 14px; text-align: start; font-weight: bolder;">
                                                Period Detail
                                            </p>
                                            <div class="mt-1" style="display: flex">
                                                <div class="point2 addclass">Period</div>
                        ...
                        <div class="point2 addclass">{{ item.contract_count }}</div>
                                            ...
                                            <div class="mt-1" style="display: flex">
                                                ...
                                                <div class="point2 addclass" style="color: #2197f3">
                                                    ...
                                                    <span style="color: rgb(76, 175, 80)"
                                                        v-if="item.result_color === 'Green'">{{
                                                        item.result_color }}</span>
                                                    <span style="color: #ff0000"
                                                        v-else-if="item.result_color === 'Red'">{{ item.result_color
                                                        }}</span>
                                            ...
                                            <div class="mt-1" style="display: flex">
                                                ...
                                                <div class="point2 addclass"
                                                    style="color: #ff0000 !important; font-size: 14px" v-else>
                                                    {{ item.status }}
                                                </div>
                                            </div>
                                            <div class="mt-1" style="display: flex">
                            ...
                            <tr v-on:click="
                                ...
                                <td class="myRecordTd" style="border: none">
                                    ...
                                    <div id="t" class="detail mt-1 mb-1 p-1"
                                        v-show="isResultCollapseOpen === item.id ? true : false"
                                        style="padding: 0px 30px">
                                        <p style="color: #2d9688; text-align: start; font-weight: bolder;">Period Detail
                                        </p>
                                        <div class="mt-1" style="display: flex">
                                            <div class="point2 addclass">Period</div>
