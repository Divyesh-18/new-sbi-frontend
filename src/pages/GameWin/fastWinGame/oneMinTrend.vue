                            ...
                            <div class="van-cell-group van-hairline--top-bottom">
                                        ...
                                        <div class="van-progress">
                                            <span class="van-progress__portion" style="background: rgb(21, 114, 57)"
                                                :style="'width:' + greenloader + '%;'"><span class="van-progress__pivot"
                                                    style="background: rgb(21, 114, 57)"
                                                    :style="'left:' + 90 + '%;'">Green:{{ greencount
                                                    }}</span></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion" style="background: rgb(232, 57, 241)"
                                                :style="'width:' + violetloader + '%;'"><span
                                                    class="van-progress__pivot" style="background: rgb(232, 57, 241)"
                                                    :style="'left:' + 90 + '%;'">Violet:{{ violetcount
                                                    }}</span></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 2%"><span
                                                    class="van-progress__pivot"
                                                    style="left: 30%; background: rgb(0, 122, 204)">0:12</span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 5%"><span
                                                    class="van-progress__pivot"
                                                    style="left: 30%; background: rgb(0, 122, 204)">1:36</span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 5%"><span
                                                    class="van-progress__pivot"
                                                    style="left: 30%; background: rgb(0, 122, 204)">2:37</span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 3%"><span
                                                    class="van-progress__pivot"
                                                    style="left: 30%; background: rgb(0, 122, 204)">3:44</span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 2.5%"><span
                                                    class="van-progress__pivot"
                                                    style="left: 30%; background: rgb(0, 122, 204)">4:44</span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 51.04px"><span
                                                    class="van-progress__pivot"
                                ...
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 112.56px"><span
                                                    class="van-progress__pivot"
                                ...
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 102.08px"><span
                                                    class="van-progress__pivot"
                                ...
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 114.84px"><span
                                                    class="van-progress__pivot"
                                ...
                                <div class="van-cell">
                                    <div class="van-cell__value van-cell__value--alone">
                                        <div class="van-progress">
                                            <span class="van-progress__portion"
                                                style="background: rgb(0, 122, 204); width: 140.36px"><span
                                                    class="van-progress__pivot"
