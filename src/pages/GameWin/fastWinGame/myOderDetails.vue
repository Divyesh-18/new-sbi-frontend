<template>
    <div class="content_con">
        ...
        <div class="table-container custom-remove-shadow">
            <table class="table table-borderless" id="myrecordparityt">
                ...
                <tbody>
                    ...
                    <tr v-on:click="toggleWaitCollapse(item._id)" v-for="item in fastWinUserWaitList" class="clickable"
                        :key="item.periodid">
                    ...
                    <tr v-on:click="toggleResultCollapse(item.id)" v-for="item in fastWinUserResultList"
        ...
        <div v-show="fastWinUserWaitList?.length <= 0 && !fastWinUserResultList.length" class="no-data-text text-dark">
            <span>
        ...
        <div class="pagination">
            <ul class="page_box">
                <li class="page text-white">
                    <span>{{
                        fastWinUserPage * fastWinUserPageRow - fastWinUserPageRow + 1
                        }}-{{ fastWinUserPage * fastWinUserPageRow }}
                    </span>
                    of {{ fastWinUserTotal }}
                </li>
                <li class="page_btn text-white">
                    <i class="van-icon van-icon-arrow-left cursor-pointer"
                        v-on:click="fastWinUserPageChange(fastWinUserPage - 1)"></i>
